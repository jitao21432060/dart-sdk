...
#error Unimplemented
  ...
  // Load number of arguments into R5 and adjust count for type arguments.
  __ LoadCompressedSmiFieldFromOffset(R5, R4,
                                  target::ArgumentsDescriptor::count_offset());
  __ LoadCompressedSmiFieldFromOffset(R3, R4,
...
void StubCodeCompiler::GenerateInterpretCallStub(Assembler* assembler) {
  ...
  __ LoadCompressedSmiFieldFromOffset(R2, R4,
                                  target::ArgumentsDescriptor::count_offset());
  __ SmiUntag(R2);
  __ LoadCompressedSmiFieldFromOffset(R1, R4,
                         target::ArgumentsDescriptor::type_args_len_offset());
  __ cmp(R1, Operand(0));
...
void StubCodeCompiler::GeneratePatchFuntionCallStub(Assembler* assembler) {
  ...
  __ CompareClassId(R0, kICDataCid);
