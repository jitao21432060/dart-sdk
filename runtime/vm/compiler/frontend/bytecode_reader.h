...
class BytecodeReaderHelper : public ValueObject {
...
#if defined(DART_DYNAMIC_RUNTIME)
  void AlignClass(const Library& aotLibrary, const Class& aotClass,
                  const Library& tmpLibrary, const Class& tmpClass);
#endif
 ...
 private:
  ...
  TypePtr ReadFunctionSignature3(const Function& signature,
                                bool has_optional_positional_params,
                                bool has_optional_named_params,
                                bool has_type_params,
                                bool has_positional_param_names,
                                bool has_parameter_flags,
                                Nullability nullability);
  FunctionTypePtr ReadFunctionSignature2(const Function& func,
                                bool has_optional_positional_params,
                                bool has_optional_named_params,
                                bool has_type_params,
                                bool has_positional_param_names,
  ...
  void ReadTypeParametersDeclaration2(const Class& parameterized_class,
                                     const Function& parameterized_function);
...
class BytecodeReader : public AllStatic {
 public:
  ...
  static ObjectPtr ReadAnnotation2(const Library& library,
  ...
  static ArrayPtr ReadExtendedAnnotations2(const Library& library,
                                           intptr_t bytecode_offset,
                                           intptr_t count);
